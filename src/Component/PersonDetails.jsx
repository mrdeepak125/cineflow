...
const PersonDetails = () => {
  ...
  useEffect(() => {
    const fetchPersonDetails = async () => {
      try {
        const [detailsResponse, movieCreditsResponse, tvCreditsResponse] =
          await Promise.all([
            axios.get(
              `https://api.themoviedb.org/3/person/${personId}?api_key=7607c1248159387aca334387ac63e608`
            ),
            axios.get(
              `https://api.themoviedb.org/3/person/${personId}/movie_credits?api_key=7607c1248159387aca334387ac63e608`
            ),
            axios.get(
              `https://api.themoviedb.org/3/person/${personId}/tv_credits?api_key=7607c1248159387aca334387ac63e608`
            ),
          ]);
        ...
        <div className="person-details">
          ...
          <div className="person-info">
            ...
            <p>
              ...
              {genderMap[personDetails.gender]}
            </p>
          </div>
        </div>
