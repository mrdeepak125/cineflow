      ...
      try {
        ...
        const [movieResponse, tvResponse] = await Promise.all([
          axios.get(`${BASE_URL}/movie`, {
            params: { api_key: API_KEY, query: e.target.value },
          }),
          axios.get(`${BASE_URL}/tv`, {
            params: { api_key: API_KEY, query: e.target.value },
          }),
        ]);
        ...
        const combinedResults = [
          ...movieResponse.data.results.map((result) => ({
            ...result,
            type: "movie",
          })),
          ...tvResponse.data.results.map((result) => ({
            ...result,
            type: "tv",
          })),
        ];
        ...
        >
          ...
          <ul>
            <li className="second-section">
              <Link to="/TopMovies" onClick={toggleMenu}>
                Top Movies
              </Link>
          ...
          <ul>
            <li className="third-section">
              <Link to="/Tvlist" onClick={toggleMenu}>
                TV
              </Link>
              <Link to="/Anime" onClick={toggleMenu}>
                Anime
              </Link>
            </li>
          </ul>
